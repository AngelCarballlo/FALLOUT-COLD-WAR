...
public class EventoPartida extends JPanel implements ActionListener {
	...
	public EventoPartida() {
		...
		objetivos.setBounds(360, 940, 190, 57);
	...
	private void empezar() {
		...
		// actualizamos numero de ronda
		numRonda.setText("" + Recursos.ronda);

		// sacamos el jugador del turno actual
		...
		// seteamos los componentes con la informacion del jugador actual
		...
		// vaciamos lista de ataque y combobox para rellenarlo de nuevo
		listaAtacar.clear();
		...
		// rellenamos el jcombobox con la lista de ataque
	...
	private void comprobar() {
		// comprobamos si hay jugadores muertos y si hay empate o victoria
		...
		if (Recursos.jugadoresMuertos == Recursos.listaJugador.size() && jugadorActual.getVida() <= 0) {
			terminarJuego();
			JFrame evento = (JFrame) SwingUtilities.getWindowAncestor(this);
			evento.remove(this);
